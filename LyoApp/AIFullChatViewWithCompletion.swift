...
struct AIFullChatViewWithCompletion: View {
    ...
    private var inputSection: some View {
                ...
                TextField("What do you want to learn today?", text: $viewModel.currentInput, axis: .vertical)
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: DesignTokens.Radius.lg)
                            ...
                            .shadow(color: DesignTokens.Colors.neonBlue.opacity(0.10), radius: DesignTokens.Shadows.elevation1.radius, x: 0, y: 2)
                    )
                    .lineLimit(1...4)
                    .onSubmit {
                        sendUserMessage()
        ...
        .shadow(color: DesignTokens.Colors.neonBlue.opacity(0.08), radius: DesignTokens.Shadows.elevation1.radius, x: 0, y: -2)
    }
