...
/// THE ONLY CONFIGURATION FILE - PRODUCTION ONLY
...
public struct ProductionOnlyConfig {
    ...
    public static let ALLOW_ENVIRONMENT_SWITCHING = false
    ...
    public static let REQUEST_TIMEOUT: TimeInterval = 30.0
    public static let UPLOAD_TIMEOUT: TimeInterval = 120.0
    public static let MAX_RETRIES = 3
    public static let RETRY_DELAY: TimeInterval = 2.0
    ...
    // MARK: - GET BASE URL - ALWAYS RETURNS PRODUCTION
    public static func getBaseURL() -> URL {
        validate() // Validate on every access
    ...
    // MARK: - CHECK IF URL IS PRODUCTION
    public static func isProductionURL(_ url: String) -> Bool {
        return url.contains("lyo-backend-830162750094")
    }
    
    // MARK: - PREVENT DEV/STAGING ACCESS
