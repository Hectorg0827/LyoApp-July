...
struct SyllabusPreviewView: View {
    ...
    private func courseOverviewCard(_ course: ClassroomCourse) -> some View {
    ...
    private func modulesSection(_ course: ClassroomCourse) -> some View {
...
#Preview {
    ZStack {
        ...
        SyllabusPreviewView(coordinator: {
            ...
            c.generatedCourse = ClassroomCourse.mockCourse
            return c
        }())
    }
}
