...
struct QuizView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: DesignTokens.Spacing.lg) {
            ...
            // Questions
            ForEach(data.questions) { (question: LessonQuizQuestion) in
                QuizQuestionView(
                    question: question,
...
struct QuizQuestionView: View {
    let question: LessonQuizQuestion
...
struct QuizResultsView: View {
    let questions: [LessonQuizQuestion]
    ...
    ScrollView {
        VStack(spacing: DesignTokens.Spacing.lg) {
            LessonBlockView(block: LessonBlock(
                id: UUID(),
                type: .heading,
                data: .heading(HeadingData(text: "Sample Heading", level: 1, style: nil)),
                order: 0
            ))
            ...
            LessonBlockView(block: LessonBlock(
                id: UUID(),
                type: .paragraph,
                data: .paragraph(ParagraphData(text: "This is a sample paragraph to demonstrate the paragraph component.", style: nil)),
                order: 1
            ))
