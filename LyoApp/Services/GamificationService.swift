...
enum UserLevel: String, Codable, CaseIterable {
    ...
    var color: Color {
        switch self {
        case .bronze: return DesignTokens.Colors.bronze
        case .silver: return DesignTokens.Colors.silver
        case .gold: return DesignTokens.Colors.gold
        case .platinum: return DesignTokens.Colors.platinum
        case .diamond: return DesignTokens.Colors.diamond
        }
    }
...
struct Badge: Identifiable, Codable, Equatable {
    ...
    enum BadgeRarity: String, Codable {
        ...
        var color: Color {
            switch self {
            case .common: return DesignTokens.Colors.textTertiary
            case .rare: return DesignTokens.Colors.accent
            case .epic: return DesignTokens.Colors.brand
            case .legendary: return DesignTokens.Colors.gold
            }
        }
    }
