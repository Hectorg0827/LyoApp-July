...
struct SearchView: View {
    ...
    private func searchUsers() async {
        do {
            ...
            searchResults = generateMockUserResults()
        }
    }
    ...
    private func searchPosts() async {
        do {
            ...
            searchResults = generateMockPostResults()
        }
    }
    ...
    private func searchContent() async {
        do {
            ...
            searchResults = generateMockCourseResults()
        }
    }
        ...
        SearchResults(
            ...
            posts: [
                FeedPost(
                    ...
                    username: "developer",
                    userAvatar: nil,
                    content: "Just finished my latest SwiftUI project!",
                    imageURLs: nil,
                    videoURL: nil,
                    likesCount: 12,
                    commentsCount: 3,
            ...
            courses: [
                APILearningResource(
                    ...
                    description: "Learn SwiftUI from the ground up",
        ...
        SearchResults(
            users: [
                UserProfile(
                    ...
                    bio: "Matching your search query",
                    profileImageUrl: nil,
                    followersCount: 100,
                    followingCount: 50,
                    postsCount: 15,
        ...
        SearchResults(
            ...
            posts: [
                FeedPost(
                    ...
                    userAvatar: nil,
                    content: "This post matches your search for \(searchText)",
                    imageURLs: nil,
                    videoURL: nil,
                    likesCount: 8,
                    commentsCount: 2,
    ...
    private func generateMockCourseResults() -> SearchResults {
        SearchResults(
            ...
            courses: [
                APILearningResource(
                    id: UUID().uuidString,
                    title: "\(searchText) Mastery Course",
                    description: "Master \(searchText) with this comprehensive course",
                    category: "Programming",
